...
public class BasicShooterOrangeSoldier : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogWarning(
                "[BasicShooterOrange] Animator belum di-assign (harus child Visual)."
            );
        }
    }
    ...
    // ==================================================
    // DIPANGGIL OLEH ShooterAnimationEventOrange
    // ==================================================
