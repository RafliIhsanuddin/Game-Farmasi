...
public class BasicShooterBlueSoldier : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogWarning(
                "[BasicShooterBlue] Animator belum di-assign (harus child Visual)."
            );
        }
    }
    ...
    // ==================================================
    // DIPANGGIL OLEH ShooterAnimationEventBlue
    // ==================================================
